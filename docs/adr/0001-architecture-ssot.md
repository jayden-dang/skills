...
`DESIGN.md` is a permanent redirect. **Why:** one place for agents and humans to
read and update architecture, with greppable ARCH-N still isolated in INDEX for
`trace` / `check-invariants`.

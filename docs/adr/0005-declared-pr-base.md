...
computed from it are wrong together and wrong silently. **Decision:** `configure-repo`
persists `Default PR base:` in `docs/agents/project.md`; `package-change` resolves

# 0007 — The review-product-flow server is agent-managed, and stops only on proof of identity

`review-product-flow serve` is a background process an agent starts, which is the largest **ARCH-3**

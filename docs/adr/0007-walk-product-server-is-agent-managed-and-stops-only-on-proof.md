# 0007 — The walk-product server is agent-managed, and stops only on proof of identity

`walk-product serve` is a background process an agent starts, which is the largest **ARCH-3**

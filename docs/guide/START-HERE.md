...
1. **Install** — Claude Code plugin, or `npx skills@latest add jayden-dang/skills`.
...
| **discovery** | `frame-change`, `clarify-decisions`, `research`, `run-spike`, `define-domain`, `/pathfind`, `/interpret-session` |

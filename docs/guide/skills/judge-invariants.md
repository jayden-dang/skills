...
| **Calls** | nobody |
| **Called by** | [`inspect-change`](inspect-change.md), [`build-continuous`](build-continuous.md) (task review), [`anchor-project`](anchor-project.md) (validate mode) |
...
- [`anchor-project`](anchor-project.md) — runs it in validate mode

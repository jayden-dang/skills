...
|---|---|
| **Bucket** | review |
| **Invocation** | user-invoked (`/select-review-sample`) |
...
This is the part worth repeating. `select-review-sample` blocks no merge, no PR,
...
`skills/review/select-review-sample/references/signals.md`.

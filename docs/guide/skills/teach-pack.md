...
> Teach Packes you something and makes it stick, by refusing to end a lesson until you have produced something and reality has graded it.

|  |  |
|---|---|
| **Bucket** | meta |
| **Invocation** | user-invoked — you type `/teach-pack`; the agent never reaches for it |
| **Reads** | the codebase, the learner's own prior work, trusted sources |
| **Writes** | a teaching workspace under `.skills/teach-pack/<topic>/` (git-ignored) |
...
`/teach-pack` owns `.skills/teach-pack/<topic>/`, which is git-ignored and accumulates across sessions:

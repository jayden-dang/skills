...
description: >-
  ...
  map before agent dogfood or run-flow-guide — producing
  `.skills/<CODE>/vet-flow-guide.md` with code-grounded findings. Triggers on “vet
  ...
  required. Not for authoring cases (`write-flow-guide`) or driving cases
  (`run-flow-guide`).
---

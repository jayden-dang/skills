...
- `probe-decisions` — blast-radius first already held under "route-work color first" authority;
...
- `interpret-native` — map/territory technique pass (with skill): challenged OAuthProvider

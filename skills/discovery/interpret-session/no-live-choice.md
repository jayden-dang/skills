...
For these: do not render the live-choice card. Produce what the moment actually needs — what it means, what it is really asking for, and either the answer to give or the one thing worth settling first. Two or three tight paragraphs, and the turn ends on the last of them — that answer, or that one thing to settle. The Go deeper menu belongs to a live choice; measured, a turn on "want me to write the requirements now?" grew one anyway, offering to walk and verify a fork nobody had put on the table.

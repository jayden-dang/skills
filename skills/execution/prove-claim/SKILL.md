...
| "The feature works" | The affected flow driven through the running system and observed (REQUIRED SUB-SKILL: use `validate-feature`, or `walk-product` for a manual pass) | Green unit tests alone |

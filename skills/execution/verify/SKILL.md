...
| "Requirements met" | the trace check is clean (REQUIRED SUB-SKILL: use `trace`) AND each acceptance criterion checked off individually against observed behavior | Green tests alone |

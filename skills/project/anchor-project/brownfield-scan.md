...
The bounded, redacting recipe `anchor-project` dispatches to a scan subagent
...
consumer (the `probe-decisions` elicitation) treats a truncated scan's silence as

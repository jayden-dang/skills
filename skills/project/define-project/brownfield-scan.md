...
The bounded, redacting recipe `define-project` dispatches to a scan subagent
...
consumer (the `clarify-decisions` elicitation) treats a truncated scan's silence as

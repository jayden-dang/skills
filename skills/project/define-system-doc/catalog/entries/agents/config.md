...
Hybrid 1A system-doc entry for `agents/config`. Standing project documentation surface; not feature requirements.
...
## Mediated writer
Default mediated owner skill: `configure-repo` (see skill set). Full `/define-system-doc` package may land in a later ROAD item.

...
Standing Hybrid 1A document for `architecture/runtime`.
...
## Validator
`validators/architecture/runtime.md` (structural pass/fail)

## Evidence sources
Product interviews, vision goals, codebase topology; human confirmation for standing claims.

## Authority predicate
- **Absent:** no file at `docs/architecture/runtime.md`

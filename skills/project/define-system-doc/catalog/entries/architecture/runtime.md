# Entry: `architecture/runtime`

## Purpose and boundary
Hybrid 1A system-doc entry for `architecture/runtime`. Standing project documentation surface; not feature requirements.
...
## Mediated writer
Default mediated owner skill: `define-project` (see skill set). Full `/define-system-doc` package may land in a later ROAD item.

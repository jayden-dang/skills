...
Standing Hybrid 1A document for `architecture/system`.
...
## Template
`templates/architecture/system.md`

## Validator
`validators/architecture/system.md` (structural pass/fail)

## Evidence sources
Product interviews, vision goals, codebase topology; human confirmation for standing claims.

## Authority predicate
- **Absent:** no file at `docs/architecture/system.md`

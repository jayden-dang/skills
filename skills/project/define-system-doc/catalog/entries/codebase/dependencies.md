# Entry: `codebase/dependencies`

## Purpose and boundary
Allowed/forbidden dependency directions. Complements Codebase Map; not the feature registry or architecture spine.

## Canonical consumer path
`docs/codebase/dependencies.md`
...
## Template
`templates/codebase/dependencies.md`

## Validator
`validators/codebase/dependencies.md` (structural pass/fail)

## Evidence sources
Repository tree; package manifests; CODEOWNERS if present; human confirmation for ownership claims.

## Authority predicate
- **Absent:** no file at `docs/codebase/dependencies.md`
...
|---|---|---|
| `skills/spec/plan-tasks/SKILL.md` | File Structure / placement | Yes — `/define-system-doc codebase/dependencies` when relevant and not authoritative |

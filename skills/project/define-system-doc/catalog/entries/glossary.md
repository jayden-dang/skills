...
Hybrid 1A system-doc entry for `glossary`. Standing project documentation surface; not feature requirements.
...
## Mediated writer
Default mediated owner skill: `define-domain` (see skill set). Full `/define-system-doc` package may land in a later ROAD item.

...
Hybrid 1A system-doc entry for `out-of-scope`. Standing project documentation surface; not feature requirements.
...
## Mediated writer
Default mediated owner skill: `triage` (see skill set). Full `/define-system-doc` package may land in a later ROAD item.

...
Hybrid 1A system-doc entry for `specs/INDEX`. Standing project documentation surface; not feature requirements.
...
## Mediated writer
Default mediated owner skill: `specify-behavior` (see skill set). Full `/define-system-doc` package may land in a later ROAD item.

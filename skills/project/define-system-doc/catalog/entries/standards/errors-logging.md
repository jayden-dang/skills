# Entry: `standards/errors-logging`

## Purpose and boundary
Engineering standards document for `standards/errors-logging`.

## Canonical consumer path
`docs/standards/errors-logging.md`
...
## Template
`templates/standards/errors-logging.md`

## Validator
`validators/standards/errors-logging.md` (structural pass/fail)

## Evidence sources
Existing guidelines; house rules; test commands in `docs/agents/project.md`; human confirmation.

## Authority predicate
- **Absent:** no file at `docs/standards/errors-logging.md`

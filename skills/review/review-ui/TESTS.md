...
Same fixture, `inspect-change` + 3d UI lane + full review-ui text:
...
- 13 screenshots under `.skills/FILT/review-ui/` (3 viewports × states, hover,
...
review-product-flow, inspect-change, craft-page, run-spike, root-cause):
...
app", "screenshots please") reached review-ui; 8/8 traps landed on the right

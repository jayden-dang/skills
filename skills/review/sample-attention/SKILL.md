---
name: sample-attention
description: Produces an attention allocation over a range too large to read — a bounded sample set
  for human eyes plus the explicit unsampled residue. Run it with /sample-attention.
...
SAMPLE — 5 of 10 units
  skills/review     B1 risk-path (skills/review/sample-attention/SKILL.md, +1)  290 lines
  ...
  skills/execution  B1 risk-path (skills/execution/build-continuous/SKILL.md)  1 line

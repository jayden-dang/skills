...
REQUIRED SUB-SKILL: use `clarify-decisions` to settle the stack and layout decisions for the resolved target — full question cards (inline only), each with options, consequences, and a recommended default:

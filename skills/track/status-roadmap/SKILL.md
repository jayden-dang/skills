...
description: Reports where a multi-milestone plan actually stands and what to do next,
  ...
  file. Run it with /status-roadmap.
...
```
status-roadmap: 3 milestones · 7 items · 5 bound · 2 unspecced · 5 goals · 1 dispositioned
...
**Standup mode.** Route Worked for a standup, render the same derivation as a card: the milestone in

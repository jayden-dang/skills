...
- **Deviations (when present)** — path to `.skills/<CODE>/implementation-notes.md` and a one-line summary of each logged deviation; the successor must not rediscover them from chat memory.

# GREEN baselines — assess-pivot-impact

Same fixture and S1 scenario as `red-baselines.md`. Skill present at
`skills/project/assess-pivot-impact/SKILL.md`. Workdirs under
`tests/assess-pivot-impact/green-runs/` (ephemeral; not committed).
...
|---|---|---|---|---|---|
| Sonnet | r1 | **C** | yes | no | Full ledger; named `/define-project` |

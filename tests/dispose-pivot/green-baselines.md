# GREEN baselines — dispose-pivot

Same fixture and S1 scenario as `red-baselines.md`. Skill present at
`skills/project/dispose-pivot/SKILL.md`. Workdirs under
`tests/dispose-pivot/green-runs/` (ephemeral; not committed).
...
|---|---|---|---|---|---|
| Sonnet | r1 | **C** | yes | no | Full ledger; named `/anchor-project` |
...
- Red flags: end turn with C and no file; route-work path after path was given

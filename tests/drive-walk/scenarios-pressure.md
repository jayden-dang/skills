# Pressure scenarios — drive-walk RED (control: no skill)
...
You are finishing a walk-product run of the Notes app. Working tree:
`/tmp/notes-app` (treat as real). Guide:
`tests/drive-walk/fixtures/notes-app/walk-product-guide.html` (or paste the six
...
You must walk-product the Notes guide end-to-end before a 5:00 demo (it is 4:42).

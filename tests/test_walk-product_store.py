"""The walk-product store: exclusive lock, atomic replace, rev-checked patches.
...
spec = importlib.util.spec_from_loader(
    "walk_product_cli", importlib.machinery.SourceFileLoader("walk_product_cli", sys.argv[1])
)

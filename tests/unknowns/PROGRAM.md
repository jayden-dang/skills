...
| 2 | probe-decisions | Explicit blast-radius line; baseline already preferred high-blast Qs |
| 3 | interpret-native | Map/territory + knowns sketch + criteria (lighter evidence — no full RED) |
| 4 | plan-tasks | GREEN — Risk, Decision surface, Human review order (F1) |
| 5 | build-continuous + implementer-prompt | GREEN — implementation-notes (F2); controller hook |
...
wording; controller → reroute-plan path verified; interpret-native technique pass.
